...
exports.accDiv = exports.accSub = exports.accMul = exports.accAdd = void 0; // 计算小数点位数
...
function getCorrectResult(styles, num1, num2, result) {
  var temp_result = 0;
